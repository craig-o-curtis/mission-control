...
DATABASE_URL=mysql+pymysql://root:<.env.MYSQL_ROOT_PASSWORD>@localhost:3306/tasks_application_database
...
TEST_DATABASE_URL=postgresql+psycopg://postgres:12345678@localhost:5432/TasksApplicationDatabase uv run pytest
```
...
TEST_DATABASE_URL=mysql+pymysql://root:12345678@localhost:3306/tasks_application_database uv run pytest
```
